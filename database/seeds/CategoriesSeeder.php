...
class CategoriesSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
        	...
        	['id' => 17, 'name' => 'Cảm biến siêu âm', 'slug' => 'cam-bien-am-thanh', 'parent_id'=> 16],
        	['id' => 18, 'name' => 'Cảm biến vật cản hồng ngoại', 'slug' => 'cam-bien-am-thanh', 'parent_id'=> 16],
        	['id' => 19, 'name' => 'Cảm biến vật cản ra đa', 'slug' => 'cam-bien-am-thanh', 'parent_id'=> 16],
        	...
        	['id' => 27, 'name' => 'Đèn báo DYI', 'slug' => 'den-bao', 'parent_id'=> 22],
            ...
            ['id' => 31, 'name' => 'Đèn báo có còi hàng Đài Loan', 'slug' => 'den-bao', 'parent_id'=> 23],
            ['id' => 32, 'name' => 'Đèn báo có còi hàng Nhật Bản', 'slug' => 'den-bao', 'parent_id'=> 23],
            ['id' => 33, 'name' => 'Đèn báo AC Nhật', 'slug' => 'den-bao', 'parent_id'=> 28],
            ['id' => 34, 'name' => 'Đèn báo AC Đức', 'slug' => 'den-bao', 'parent_id'=> 28],
            ['id' => 35, 'name' => 'Đèn báo AC Mỹ', 'slug' => 'den-bao', 'parent_id'=> 28],
        ];
